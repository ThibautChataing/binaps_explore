...
cmd="ovhai job run --name binaps-num-$1 --flavor ai1-1-gpu --gpu $nbr_gpu --volume input@GRA/:/workspace/container_0:RW --volume output@GRA/:/workspace/container_1:RW tchataing/binaps:run -- python /workspace/binaps_explore/Binaps_code/main.py --hidden_dim $hidden_dim --thread_num $(($nbr_gpu * 13)) $no_gpu --epochs 100 --output_dir	/workspace/container_1 -i";
