...
cmd="ovhai job run --name binaps-num-$1 --flavor ai1-1-gpu --gpu $nbr_gpu --volume output@GRA/:/workspace/container_0:RW:cache tchataing/binaps:run -- python /workspace/binaps_explore/Binaps_code/main.py --hidden_dim $hidden_dim --thread_num $(($nbr_gpu * 13)) --save_model --output_dir	/workspace/container_0 -i";
